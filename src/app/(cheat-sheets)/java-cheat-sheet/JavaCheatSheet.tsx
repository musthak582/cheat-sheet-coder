  ...
  return (
    <div className="w-full flex flex-col bg-white xl:px-[100px] sm:px-4 px-2">
      <div className={`w-full bg-zinc-100 flex lg:flex-col lg:items-center lg:justify-center lg:gap-4 gap-2 sm:py-4 py-2`}>
        ...
        <p className='max-w-4xl hidden lg:inline text-[20px] text-slate-700 text-center'>Access our free Java Cheat Sheet to master syntax, classes, and methods. This comprehensive guide includes practical examples for efficient Java programming. Perfect for quick reference!</p>
      </div>
