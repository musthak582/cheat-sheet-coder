  ...
  return (
    <div className="w-full flex flex-col bg-white xl:px-[100px] sm:px-4 px-2">
      <div className={`w-full bg-zinc-100 flex lg:flex-col lg:items-center lg:justify-center lg:gap-4 gap-2 sm:py-4 py-2`}>
        ...
        <p className='max-w-4xl  hidden lg:inline text-[20px] text-slate-700 text-center'>Enhance your styling skills with our free CSS Cheat Sheet. Perfect for beginners and web developers. Get quick references to style web pages effectively and create stunning designs effortlessly.</p>
      </div>
