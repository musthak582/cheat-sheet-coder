...
import { jsCodeBlocks } from '../../../../public/data/js-code'
  ...
  return (
    <div className="w-full flex flex-col bg-white xl:px-[100px] sm:px-4 px-2">
      <div className={`w-full bg-zinc-100 flex lg:flex-col lg:items-center lg:justify-center lg:gap-4 gap-2 sm:py-4 py-2`}>
        ...
        <h2 className='lg:text-3xl md:text-2xl text-[20px] text-center font-extrabold text-slate-900 '>JavaScript Cheat Sheet</h2>
        <p className='max-w-4xl hidden lg:inline text-[20px] text-slate-700 text-center'>Master JavaScript essentials with our free JavaScript Cheat Sheet. Perfect for beginners and developers. Get quick references for variables, functions, and DOM manipulation to build interactive web applications effortlessly.</p>
      </div>
